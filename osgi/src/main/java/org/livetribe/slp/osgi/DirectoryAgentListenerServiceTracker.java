 ...
 */
public class DirectoryAgentListenerServiceTracker extends ServiceTracker
{
    ...
    public DirectoryAgentListenerServiceTracker(BundleContext context, ServiceAgent serviceAgent)
    {
        super(context, DirectoryAgentListener.class.getName(), null);
    ...
    public Object addingService(ServiceReference reference)
    {
        ...
        serviceAgent.addDirectoryAgentListener(listener);
    ...
    public void removedService(ServiceReference reference, Object listener)
    {
        ...
        serviceAgent.addDirectoryAgentListener((DirectoryAgentListener) listener);
