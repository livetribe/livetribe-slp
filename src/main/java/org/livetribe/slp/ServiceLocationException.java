 ...
 * Details about what happened are provided by an {@link #getError() error}.
...
public class ServiceLocationException extends RuntimeException
{
    ...
    public ServiceLocationException(Error error)
    {
        this(null, null, error);
    }

    public ServiceLocationException(String message, Error error)
    {
        this(message, null, error);
    }

    public ServiceLocationException(Throwable cause, Error error)
    {
        this(null, cause, error);
    }

    public ServiceLocationException(String message, Throwable cause, Error error)
    {
        super(message, cause);
        this.error = error;
    }
