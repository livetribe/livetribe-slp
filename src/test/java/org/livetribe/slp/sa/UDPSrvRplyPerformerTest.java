...
public class UDPSrvRplyPerformerTest
{
    ...
    public void testOverflow() throws Exception
    {
        ...
        {{
                oneOf(connector).unicastSend(with(aNonNull(String.class)), with(aNonNull(InetSocketAddress.class)), with(new BitMatch(5, (byte)0x80)));
        ...
        usrp.perform(InetSocketAddress.createUnresolved("localhost", 4207),
